    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><p><button type="button" class="btn glyphicon glyphicon-log-in" id="myBtn">LOGIN</button></p></li>
			</ul>
		</div>
	</nav>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="post" action="ceklogin.php">
            ...
            <div class="form-group" method="post">
              ...
              <button type="submit" id="submit" nama="submit" class="btn glyphicon " method="post"><span class="glyphicon glyphicon-off"></span> Login</button>
          </form>     
